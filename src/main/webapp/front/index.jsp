...
<html>
	...
	<style type="text/css">
		...
		#header .nav-top {
			...
			height: 65px;
			background: linear-gradient(270deg, #918F84 0%, #64503B 100%);
		...
		#header .navs {
			...
			box-sizing: border-box;
			height: 70px;
			background: linear-gradient(98deg, #928A81 0%, #EEEEEE 100%, #E6EFFF 100%);
		...
		#header .navs li.current {
			...
			border-width: 3px 0;
			border-style: solid;
			border-color: rgba(117, 107, 115, 1);
			background-color: rgba(226, 209, 196, 1);
			box-shadow: 0 0 0px 0px #7f7667;
		}
	...
	<body>
		...
		<div id="header">
			<div v-if='true' class="nav-top">
			  <img v-if='true' class="nav-top-img" src='http://codegen.caihongy.cn/20220111/81028d16f04f4d9787ff72296485ef8e.png'>
