			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">问诊编号：</label>
						<div class="layui-input-block">
							<input v-model="detail.wenzhenbianhao" type="text" :readonly="ro.wenzhenbianhao" name="wenzhenbianhao" id="wenzhenbianhao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input type="text" name="wenzhenshijian" id="wenzhenshijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div class="layui-form-item" pane>
			...
			var vue = new Vue({
				...
				data: {
					...
					ro:{
                                        ...
                                        wenzhenqingkuang : false,
                                        yaofangxinxi : false,
                                        zhanghao : false,
                                        yishengxingming : false,
					},
                    detail: {
                        wenzhenbianhao: genTradeNo(),
                        yonghuming: '',
                        xingming: '',
                        wenzhenshijian: '',
                        wenzhenqingkuang: '',
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
						  ...
						  carousel.render({
							...
							width: '100%',
						  	...
						  	indicator: 'inside'
                                ...
                                jquery('#wenzhenshijian').val(getCurDateTime());
				laydate.render({
					elem: '#wenzhenshijian',
					type: 'datetime'
				});
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='wenzhenshijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.wenzhenshijian = true;
                                                jquery('#wenzhenshijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='wenzhenqingkuang'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.wenzhenqingkuang = true;
                                                continue;
                                        }
                                        if(o=='yaofangxinxi'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.yaofangxinxi = true;
                                                continue;
                                        }
                                        if(o=='zhanghao'){
                                                vue.detail[o] = obj[o];
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('wenzhenxinxi/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('wenzhenxinxi' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
