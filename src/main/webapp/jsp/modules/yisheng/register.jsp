...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210826/52350b830aff4dd3bcbacc41e172da00.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper h1 {
		...
		border-color: rgba(0,0,0,.3);
		background-color: rgba(153, 204, 51, 0.9);
		box-shadow: 0 0 6px rgba(30, 144, 25,0);
		text-align: center;
	}
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input  name="yishengxingming" placeholder="医生姓名" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">挂号费</label> 
							<input  name="guahaofei" placeholder="挂号费" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "yisheng/register";
				$.ajax({ 
					type: "POST",
					url: url,
