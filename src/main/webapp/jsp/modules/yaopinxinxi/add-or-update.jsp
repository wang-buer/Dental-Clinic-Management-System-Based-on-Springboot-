							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>药品名称</label>
										<input name="yaopinmingcheng" id="yaopinmingcheng" name="yaopinmingcheng" class="form-control" placeholder="药品名称">
									</div>
									<div class="form-group col-md-6">
										<label>药品类型</label>
										<input name="yaopinleixing" id="yaopinleixing" name="yaopinleixing" class="form-control" placeholder="药品类型">
									</div>
									<div class="form-group col-md-6">
										<label>图片</label>
									...
									<div class="form-group col-md-6">
										<label>批次</label>
										<input name="pici" id="pici" name="pici" class="form-control" placeholder="批次">
									</div>
									<div class="form-group col-md-6">
										<label>价格</label>
									...
									<div class="form-group col-md-6">
										<label>药品说明</label>
										<textarea  name="yaopinshuoming" class="form-control" id="yaopinshuoming" rows="3"></textarea>
									</div>
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.pici != null && res.data.pici != ''){

						$("#pici").val(res.data.pici);
						$("#pici").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.yaopinshuoming != null && res.data.yaopinshuoming != ''){

						$("#yaopinshuoming").val(res.data.yaopinshuoming);
					}
				}
			});  
            }
