...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="yaopinleixingSearch" class="form-control form-control-sm" placeholder="请输入药品类型" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('pici')">批次<i id="piciIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#yaopinleixingSearch').val() != null && $('#yaopinleixingSearch').val() != ''){
				searchForm.yaopinleixing ="%" +  $('#yaopinleixingSearch').val() + "%";
			}
		...
		function setDataRow(item,number){
			...
			var piciCell  = document.createElement('td');

						 piciCell.innerHTML = item.pici;

			row.appendChild(piciCell);
			...
			var yaopinshuomingCell  = document.createElement('td');

						  if(item.yaopinshuoming != null && item.yaopinshuoming != "" && item.yaopinshuoming.length >= 11){
			  	yaopinshuomingCell.innerHTML = item.yaopinshuoming.substring(0, 10) + "..."; 
			  }else{
			  	yaopinshuomingCell.innerHTML = item.yaopinshuoming;
			  }


			row.appendChild(yaopinshuomingCell);
