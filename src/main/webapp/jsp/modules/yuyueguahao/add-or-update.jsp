...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>预约挂号管理</span></li>
								<li class="breadcrumb-item active"><span>编辑预约挂号</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>预约日期</label>
										<div id="yuyueriqiDate" class="input-append date form_datetime">
											<input id="yuyueriqi-input" name="yuyueriqi" size="20" type="text" readonly>
	...
	<script>
		...
		function dataBind(){
			...
			$("#yuyueriqi-input").val(ruleForm.yuyueriqi);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yuyueriqi != null && res.data.yuyueriqi != ''){

						$("#yuyueriqi-input").val(res.data.yuyueriqi);
						$('#yuyueriqiFileName').val(res.data.yuyueriqi)
					}
