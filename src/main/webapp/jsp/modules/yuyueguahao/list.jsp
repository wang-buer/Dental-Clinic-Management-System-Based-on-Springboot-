...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>预约挂号列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="yishengxingmingSearch" class="form-control form-control-sm" placeholder="请输入医生姓名" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('yuyueriqi')">预约日期<i id="yuyueriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var yuyueriqiCell  = document.createElement('td');

						  yuyueriqiCell.innerHTML = item.yuyueriqi;


			row.appendChild(yuyueriqiCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "问诊"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'wenzhenxinxi','是','','')");
			if(crossBtnControl('问诊') == true){
