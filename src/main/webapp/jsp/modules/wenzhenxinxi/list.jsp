...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">问诊信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>问诊信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">问诊信息列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('wenzhenbianhao')">问诊编号<i id="wenzhenbianhaoIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('wenzhenshijian')">问诊时间<i id="wenzhenshijianIcon" class="fa fa-sort"></i></th>
											<th>问诊情况</th>
											<th>药方信息</th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var wenzhenbianhaoCell  = document.createElement('td');

						 wenzhenbianhaoCell.innerHTML = item.wenzhenbianhao;

			row.appendChild(wenzhenbianhaoCell);
			...
			var wenzhenshijianCell  = document.createElement('td');

						  wenzhenshijianCell.innerHTML = item.wenzhenshijian;


			row.appendChild(wenzhenshijianCell);
			var wenzhenqingkuangCell  = document.createElement('td');

						  if(item.wenzhenqingkuang != null && item.wenzhenqingkuang != "" && item.wenzhenqingkuang.length >= 11){
			  	wenzhenqingkuangCell.innerHTML = item.wenzhenqingkuang.substring(0, 10) + "..."; 
			  }else{
			  	wenzhenqingkuangCell.innerHTML = item.wenzhenqingkuang;
			  }


			row.appendChild(wenzhenqingkuangCell);
			var yaofangxinxiCell  = document.createElement('td');

						  if(item.yaofangxinxi != null && item.yaofangxinxi != "" && item.yaofangxinxi.length >= 11){
			  	yaofangxinxiCell.innerHTML = item.yaofangxinxi.substring(0, 10) + "..."; 
			  }else{
			  	yaofangxinxiCell.innerHTML = item.yaofangxinxi;
			  }


			row.appendChild(yaofangxinxiCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "缴费"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'jiaofeixinxi','','','')");
			if(crossBtnControl('缴费') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("wenzhenxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"wenzhenxinxi");
