...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">缴费信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>缴费信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">缴费信息列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('wenzhenfei')">问诊费<i id="wenzhenfeiIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('yaopinfei')">药品费<i id="yaopinfeiIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('qitafeiyong')">其他费用<i id="qitafeiyongIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('zongfeiyong')">总费用<i id="zongfeiyongIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jiaofeishijian')">缴费时间<i id="jiaofeishijianIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jiaofeishuoming')">缴费说明<i id="jiaofeishuomingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var wenzhenfeiCell  = document.createElement('td');

						 wenzhenfeiCell.innerHTML = item.wenzhenfei;

			row.appendChild(wenzhenfeiCell);
			var yaopinfeiCell  = document.createElement('td');

						 yaopinfeiCell.innerHTML = item.yaopinfei;

			row.appendChild(yaopinfeiCell);
			var qitafeiyongCell  = document.createElement('td');

						 qitafeiyongCell.innerHTML = item.qitafeiyong;

			row.appendChild(qitafeiyongCell);
			var zongfeiyongCell  = document.createElement('td');

						 zongfeiyongCell.innerHTML = item.zongfeiyong;

			row.appendChild(zongfeiyongCell);
			var jiaofeishijianCell  = document.createElement('td');

						  jiaofeishijianCell.innerHTML = item.jiaofeishijian;


			row.appendChild(jiaofeishijianCell);
			var jiaofeishuomingCell  = document.createElement('td');

						 jiaofeishuomingCell.innerHTML = item.jiaofeishuoming;

			row.appendChild(jiaofeishuomingCell);
	...
	function printTable() {
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jiaofeixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"jiaofeixinxi");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"jiaofeixinxi");
